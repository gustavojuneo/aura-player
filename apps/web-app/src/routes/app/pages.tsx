...
import {
  MoviesPage as BrowserMoviesPage,
  SeriesPage as BrowserSeriesPage,
  TvPage as BrowserTvPage,
} from "../../pages/catalog";
...
export const MoviePlayerPage = lazyPage(() =>
  import("@aura/web-shared/pages/app/movies/$movieId/watch").then(
...
export const EpisodePlayerPage = lazyPage(() =>
  import(
    "@aura/web-shared/pages/app/series/$seriesId/episodes/$episodeId/watch"
...
export const LivePlayerPage = lazyPage(() =>
  import("@aura/web-shared/pages/app/tv/$channelId/watch").then(
